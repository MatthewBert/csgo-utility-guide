...
//icon images
import Smoke_Grenade from "../img/granade-icons/smoke-grenade.png";
import Molly_Grenade from "../img/granade-icons/molly-grenade.png";
//DONT FORGET TO IMPORT WHEN USED
//import He_Grenade from "../img/granade-icons/he-grenade.png";
//import Flash_Grenade from "../img/granade-icons/flash-grenade.png";

// map:             MapName,
// mapTitle:        MapName WITHOUT the de_ prefix,
// type:            [Smoke, Flash, Molly, Explosive]
// icon:            a png image of the icon for the utility [Smoke_Grenade,Molly_Grenade,He_Grenade,Flash_Grenade]
